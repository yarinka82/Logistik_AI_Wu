    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('client_company', 'Замовник — фірма'), ('client_individual', 'Замовник — фізична особа'), ('driver', 'Водій / перевізник'), ('accountant', 'Бухгалтер'), ('admin', 'Адміністратор системи')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='users.clientcompanyprofile')),
            ],
        ),
        migrations.CreateModel(
